...
load GNSS_South_central_Alaska_20180101_20181231        %176锟斤拷锟斤拷锟秸撅拷�???366锟斤拷锟斤拷锟秸?
altitude_matrix_databeihaidao1=GNSS_South_central_Alaska_20180101_20181231';
...
for tt=1:length(aim_station)
    ...
    while size(X,2)-ii>=predict_len+trainlength-1
        ...
        for iter=1:800         % cal coeffcient matrix B
...
rmse_station_all_South_central_Alaska=rmse_station;
save rmse_station_all_South_central_Alaska rmse_station_all_South_central_Alaska 
