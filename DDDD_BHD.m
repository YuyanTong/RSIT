...
load newdata2017_2019      
altitude_matrix_databeihaidao1=newdata2017_2019';
altitude_matrix_databeihaidao1=altitude_matrix_databeihaidao1(:,366:end);
...
while ii<20000                                                                                                                                                                                                                            %寰幆鎵ц�??3000娆★紝鍙栧潎鍊硷紝鏀瑰杽璇�??
    ii=ii+1;
...
combined_sd_y=[normal_sd_y'];
figure
plot(combined_sd_y);  
save combined_sd_y combined_sd_y
